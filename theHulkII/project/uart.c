...
/* on LPC2138: UART0 TX-Pin=P0.2, RX-Pin=P0.1 
...
//#define U0_PINSEL    ( ( PINSEL_FIRST_ALT_FUNC << PINSEL_BITPIN0 ) | ( PINSEL_FIRST_ALT_FUNC << PINSEL_BITPIN1 ) )
// Mask of Bits 0-4
//#define U0_PINMASK      (0x0000000F)    /* PINSEL0 Mask for UART0 */

// U0_LCR devisor latch bit 
//#define U0_LCR_DLAB  7
